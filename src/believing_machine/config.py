...
settings = dict(
    ...
    machine_organization_name   = environ.get('MACHINE_ORGANIZATION_NAME', 'believing-machine'),
    private_repo_with_text      = environ.get('PRIVATE_REPO_WITH_TEXT','believing_machine'),
